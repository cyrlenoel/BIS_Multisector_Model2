...
A0 x(t) = A1 x(t-1) + B0 E_t x(t+1) + D0 e(t) 
...
% Source: https://callumjones.github.io/files/dynare_str.pdf
...
out.mats.Q = F ;
out.mats.G = G ;
out.mats.unq = mats.unq ;

out.order.bp2smats_ord = mats.bp2smats_ord ;
out.order.smats2bp_ord = mats.smats2bp_ord ;

% Added by DR
out.mats.GAM0 = mats.GAM0 ; 
out.mats.GAM1 = mats.GAM1 ;
out.mats.PSI  = mats.PSI ;
